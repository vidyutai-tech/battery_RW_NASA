#!/usr/bin/env python
"""STAGE 8 — GP-BO, 80 evaluations per profile family.

Identical search space, budget, and objective as Random Search. Family seed
points only — no elites from Random Search.
"""
...
def main() -> int:
    ...
    ok = True
    for cell in cells:
        print(f"\n======== GP-BO  {cell} ========", flush=True)
        summary = run_cell(
            cell, "gp_bo", device=device,
